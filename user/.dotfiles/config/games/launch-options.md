...
```text
-XX:+UnlockExperimentalVMOptions -XX:+UnlockDiagnosticVMOptions -XX:+AlwaysActAsServerClassMachine -XX:+AlwaysPreTouch -XX:-DontCompileHugeMethods -XX:+ExplicitGCInvokesConcurrent -XX:AllocatePrefetchStyle=3 -XX:ReservedCodeCacheSize=400M -XX:NonNMethodCodeHeapSize=12M -XX:ProfiledCodeHeapSize=194M -XX:NonProfiledCodeHeapSize=194M -XX:+PerfDisableSharedMem -XX:+UseFastUnorderedTimeStamps -XX:+UseCriticalJavaThreadPriority -XX:+EagerJVMCI -XX:+UseG1GC -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=16M -XX:G1NewSizePercent=10 -XX:G1ReservePercent=20 -XX:SurvivorRatio=6 -XX:G1MixedGCCountTarget=3 -XX:G1HeapWastePercent=20 -XX:G1RSetUpdatingPauseTimePercent=5 -XX:MaxTenuringThreshold=6 -XX:G1SATBBufferEnqueueingThresholdPercent=30 -XX:G1ConcMarkStepDurationMillis=5 -XX:ConcGCThreads=3 -XX:+UseLargePages -XX:LargePageSizeInBytes=2M -XX:+ParallelRefProcEnabled -Dfml.ignoreInvalidMinecraftCertificates=true -Dfml.ignorePatchDiscrepancies=true -XX:ThreadPriorityPolicy=1 -XX:+UseStringDeduplication -XX:+UseCompressedOops -XX:+OptimizeStringConcat -Djdk.graal.OptimizeLongJumps=true -XX:G1MaxNewSizePercent=40 -XX:+UseFMA -XX:+LoopMultiversioning --add-modules=jdk.incubator.vector -Dfile.encoding=UTF-8 -XX:+UseGraalJIT -Xlog:disable -XX:+G1PeriodicGCInvokesConcurrent -XX:+UseCompactObjectHeaders -XX:+CompactStrings -XX:+TieredCompilation -XX:+OptimizeFill -XX:+UseNUMA -XX:+UseInlineCaches -XX:+SegmentedCodeCache -XX:+UseThreadPriorities -XX:+OmitStackTraceInFastThrow -XX:+RewriteBytecodes -XX:+RewriteFrequentPairs -XX:UseAVX=2 -XX:UseSSE=4 -XX:+UseAESIntrinsics -XX:+UseCodeCacheFlushing -Dsodium.checks.issue2561=false --enable-native-access=ALL-UNNAMED -Djdk.graal.CompilerConfiguration=enterprise -Djdk.graal.TuneInlinerExploration=1
```
