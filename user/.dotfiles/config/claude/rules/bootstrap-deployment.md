...
`Scripts/auto/autounattend.xml` gives a fully unattended Windows 11 install from USB:

1. Copy `autounattend.xml` to the **root of the USB drive** — the only file required
2. Boot from the USB; Windows Setup detects the file and runs unattended
