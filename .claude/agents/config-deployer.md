...
Any work involving dotfile deployment, tracked config changes, dotbot YAML, or hash-based file copy logic.
...
- For registry changes that deploy configs, provide restore logic in same script or sibling
