...
Invoke-Operation -Name 'DISM_ComponentAnalysis' -Results $Results -DryRun:$DryRun -Result 'COMPLETE' -Command 'DISM' -ArgumentList '/Online /Cleanup-Image /AnalyzeComponentStore'
Invoke-Operation -Name 'DISM_ComponentCleanup' -Results $Results -DryRun:$DryRun -Result 'COMPLETE' -Command 'DISM' -ArgumentList '/Online /Cleanup-Image /StartComponentCleanup'

# 3. Clear Windows Store Cache
Invoke-Operation -Name 'StoreCacheClear' -Results $Results -DryRun:$DryRun -Result 'CLEARED' -Command 'wsreset.exe' -ArgumentList '-i'
