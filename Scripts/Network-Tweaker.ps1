...
[void] $cb_DevicePolicy.Items.AddRange([object[]]@('MachineDefault','AllCloseProcessors','OneCloseProcessor','ProcessorsInMachine','SpecifiedProcessors','SpreadMessagesAcrossAllProcessors'))
